...
import CorsiBox from '../components/Corsi/CorsiBox'
  ...
  return (
    <div>
        <Helmet>
            ...
            <title>Federico Calò - Corsi</title>
            <link rel="canonical" href="https://www.federicocalo.dev/corsi" />
        </Helmet>
        <Navbar/>
        <HeroImg2 heading="CORSI"text="Avvicinati al mondo dell'informatica"/>
        <CorsiBox/>
        <Footer/>
    </div>
  )
