        ...
        <article itemScope itemType="https://schema.org/Article">
            ...
            <section className='post-content post-container'>
                ...
                <p className='post-text'>
                    ...
                    <strong> elementi</strong>. Per descrivere un insieme si può procedere in diversi modi, il più semplice è quello di <i>elencare</i> i vari elementi. Per indicare <i>l'appartenenza</i> o <i>la non appartenenza</i> di un elemento all'interno di un insieme si utilizzano rispettivamente i simboli <InlineMath math={inSimbolo} /> e <InlineMath math={outSimbolo} />. 
                    Gli insiemi vengono indicati con delle lettere maiuscole, inoltre quando ogni elemento di un insieme A appartiene anche ad un altro insieme B, si dice che l'insieme A è un <strong>sottoinsieme</strong> dell'insieme B, indicandolo con la seguente annotazione <InlineMath math={sottoinsiemeSimnolo} />. Un insieme privo di elementi si indica con 
                ...
                <p className='post-text'>
                    ...
                    come il prodotto di due insiemi, costituito da tutte le coppie il cui primo elemento appartiene all'insieme A e il secondo elemento all'insieme B. Un prodotto cartesiano, o <i>prodotto vettoriale</i>, viene denotato con la seguente terminologia <InlineMath math={prodottoCartesiano} />.    
                </p>
                ...
                <p className='post-text'>
                    ...
                    alfabeto</strong> è una sequenza finita di simboli dell'alfabeto, senza nessuna separazione. Se definiamo con <i>w</i> una stringa su un alfabeto <InlineMath math={simboloSommatoria} />, definiamo lunghezza di w il numero di simboli che contiene, indicando questo valore con il simbolo <InlineMath math={cardinalitaParola} />. Una stringa con cardinalità pari a 0 prende il nome 
                    di <strong>stringa vuota</strong> e viene rappresentata con il simbolo di <InlineMath math={lambda1} /> o <InlineMath math={lambda2} />. Inoltre un insieme di stringhe prende il nome di <strong>linguaggio</strong>.
                </p>
                ...
                <div className="succ-post">
                    <Link to="/Automi-e-linguaggi-regolari">Post successivo &#8594;</Link>
                </div>
            </section>
        </article>
        <Footer/>
