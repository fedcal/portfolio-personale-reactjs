  ...
  return (
    <div>
     ...
     crossorigin="anonymous"></script>
            ...
            <meta name='og:title' content='Federico Calò Blog - 1. Introduzione alle reti'/>
            <meta name='og:description' content='Articolo che introduce alla materia di reti di calcolatori, andando a definire le nozioni di base quali ISP, TCP, IP, router etc.'/>
            <meta name='og:email' content='fedcal01@gmail.com'/>
            <meta name='og:phone_number' content='+39 3332673965'/>
            <meta name="apple-mobile-web-app-title" content="Federico Calò Blog - 1. Introduzione alle reti"/> 
        ...
        <article itemScope itemType="https://schema.org/Article">
            ...
            <section className='post-content post-container'>
                ...
                <p itemProp='description' className='post-text'>Collegamenti diversi possono trasmettere dati a velocità differenti definite come <strong>velocità di trasmissione</strong> (transmission rate) e misurata in bit/secondo (bps).
