     ...
     crossorigin="anonymous"></script>
        ...
        <article itemScope itemType="https://schema.org/Article">
            ...
            <section className='post-content post-container'>
                ...
                <p itemProp='description' className='post-text'>Le applicazioni distribuite in rete scambiano dei messaggi, strutturati secondo le regole stabilite dallo sviluppatore, per poter comunicare tra loro. A prescindere dalle informazioni che il messaggio può contenere
                ...
                dimensione del pacchetto in <i>bit</i> e con R la velocità del canale di trasmissione in <i>bps</i>, il tempo di trasmissione sarà pari a <InlineMath math={frazione1} /> secondi. La metodologia di trasmissione nella commutazione
                ...
                <InlineMath math={frazione1} /> secondi avrà trasmesso il primo pacchetto che verrà memorizzato all'interno del router (escludiamo i ritardi di propagazione). Il router a sua volta comincerà a trasmettere il pacchetto al destinatario solo quando riceverà tutti i bit
                relativi ad esso. All'istante 2<InlineMath math={frazione1} /> il pacchetto sarà arrivato al destinatario. Quindi il <i>ritardo</i> di un pacchetto durante la trasmissione store-and-forward è di 2 <InlineMath math={frazione1} />, mentre se il router riuscisse a inoltrare il 
                pacchetti appena lo riceve, il ritardo sarebbe pari a <InlineMath math={frazione1} />.</p>
