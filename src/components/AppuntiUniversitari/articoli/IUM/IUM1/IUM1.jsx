    ...
    <div>
        ...
        <article itemScope itemType="https://schema.org/Article">
            ...
            <section className='post-content post-container'>
                ...
                <p itemProp='description'className='post-text first-text'> Prima di entrare nel vivo della materia occorre definire alcuni concetti chiave sulla base dei quali si basa l'interazione uomo macchina. Con l'evoluzione tecnologica sono aumentati i prodotti che supportano le attività quotidiane dell'uomo e per migliorare l'interazione con essi sono
