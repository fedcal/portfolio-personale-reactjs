    ...
    <div>
        ...
        <article itemScope itemType="https://schema.org/Article">
            ...
            <section className='post-content post-container'>
                ...
                <p itemProp='description' className='post-text first-text'>Nel mondo della progettazione del software incentrato sull'utente, è fondamentale analizzare il modo con l'utente comune andrà ad interagire con il sistema, permettendo di individuare le cause delle difficoltà durante il suo utilizzo, per poi andarle a risolvere.
