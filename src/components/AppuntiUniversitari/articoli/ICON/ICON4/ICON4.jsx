    ...
    <div>
        ...
        <article itemScope itemType="https://schema.org/Article">
            ...
            <section className='post-content post-container'>
                ...
                <ul>
                    <li><i>remember: </i> <InlineMath math={fRemember} /></li>
                    <li><i>command: </i> <InlineMath math={fCommand} /></li>
                    <li><i>tell: </i><InlineMath math={fTell} /></li>
                </ul>

                <p className='post-text'>
                    Ricordiamo che in queste espressioni S è lo stato di credenza, <InlineMath math={m2} /> è l'insieme di comandi dal layer superiore, <InlineMath math={m1} /> è l'insieme delle percezioni dello stato inferiore, <InlineMath math={m4} /> è l'insieme dei comandi per il livello inferiore, <InlineMath math={m3} /> rappresenta l'insieme delle 
