        ...
        <div className='container'>
            ...
            <section className='post container'>
                ...
                <article className='post-box uni all'>
                    ...
                    <time datetime="2023-01-07" className='post-date'> 7 Gennaio 2023</time>
                ...
                <article className='post-box uni all'>
                    ...
                    <time datetime="2023-01-01"className='post-date'> 1 Gennaio 2023</time>
                ...
                <article className='post-box uni all'>
                    ...
                    <time datetime="2022-12-30" className='post-date'> 30 Dicembre 2022</time>
                ...
                <article className='post-box uni all'>
                    ...
                    <time datetime="2022-12-17" className='post-date'> 17 Dicembre 2022</time>
                ...
                <article className='post-box casestudy all'>
                    ...
                    <time datetime="2022-12-11" className='post-date'> 11 Dicembre 2022</time>
                ...
                <article className='post-box casestudy all'>
                    ...
                    <time datetime="2022-12-04" className='post-date'> 04 Dicembre 2022</time>
                ...
                <article className='post-box uni all'>
                    ...
                    <time datetime="2022-12-01" className='post-date'> 01 Dicembre 2022</time>
                ...
                <article className='post-box uni all'>
                    ...
                    <time datetime="2022-11-20" className='post-date'> 20 Novembre 2022</time>
                ...
                <article className='post-box uni all'>
                    ...
                    <time datetime="2022-11-12" className='post-date'> 12 Novembre 2022</time>
                ...
                <article className='post-box libri all'>
                    ...
                    <time datetime="2022-11-05" className='post-date'> 5 Novembre 2022</time>
                ...
                <article className='post-box uni all'>
                    ...
                    <time datetime="2022-11-01" className='post-date'> 1 Novembre 2022</time>
