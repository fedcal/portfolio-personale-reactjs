    ...
    <div>
        ...
        <article itemScope itemType="https://schema.org/NewsArticle">
            ...
            <section className='post-content post-container'>
                ...
                <p itemProp='description'className='post-text first-text'>Faccio parte dell'associazione <a href='https://www.instagram.com/onstageaps/' target='_blank' rel="noopener noreferrer" aria-label="Onstage"className='link'>ONstage</a> e recentemente è sorta l'esigenza di organizzare le varie attività dell'associazione attraverso un gestionale 
