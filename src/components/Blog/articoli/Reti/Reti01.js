...
import SchemaRete from '../../../assets/SchemaReti.PNG';
import './Reti01.css'
import AccessoViaCavo from '../../../assets/AccessoViaCavo.PNG';
  ...
  return (
    <div>
        ...
        <section className='post-content post-container'>
            ...
            Quando un sistema periferico vuole inviare dati a un altro sistema perifierico, suddivide i dati in sotto parti e aggiunge un'intestazione a ciascuna di esse. L'insieme delle informazioni risultanti viene chiamato <strong>pacchetto</strong>.
            ...
            I principali commutatori di pacchetti sono i <strong>router</strong> e i <strong>commutatori a livello di collegamento</strong> (link-layer switch), ma ne esistono anche altri di diversa forma e natura. I commutatori a livello di collegtamento sono usati nelle reti di accesso, mentre i router nel nucleo della rete.
            ...
            su un sistema periferico possa chiedere a internet di recapitare dati a un programma eseguito su un altro sistema periferico. L'interfaccia socket consiste in un insieme di regole che il programma mittente deve seguire in modo che i dati siano reacpitati correttamente.</p>
            ...
            <p className='post-text'> Le linee telefoniche residenziali trasportano contemporanemante dati e segnali telefonici codificandoli in tre bande di frequenza non sovrapposte:</p>
            <ul>
            ...
            accesso asimmetrico, in quanto le due velocità di upstream e downstream sono diverse e possono essere anche inferiori a quelle definite dagli standard, in quanto il rpovider può limitare il tasso di trasmissione. La DSL è stata progetta per distanze piccole e utilizza infrstrutture già presenti e messe a disposizione dalla compagnia.</p>
            <p className='post-text'>A differenza della DSL, l'<strong>accesso a internet via cavo</strong> sfrutta le infrastrutture della televisione, attraverso delle fibre ottiche che connettono la terminazione del cavo a giunzioni a livello di quartiere, dalle quali parte il cavo coassiale per la distribuzione mediante la quale si raggungono le singole case e appartamenti.</p>
        </section>
        <Footer/>
    </div>
  )
