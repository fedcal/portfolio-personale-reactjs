    ...
    <div>
        ...
        <article itemScope itemType="https://schema.org/Article">
            ...
            <section className='post-content post-container'>
                ...
                <p className='post-text'>
                    Gli agenti agiscono nel tempo, quindi non possono vedere tracce percettive complete. A un tempo <i>t <InlineMath math={appartiene} /> T</i>, un agente può osservare solo il valore della traccia fino al tempo t e i suoi comandi non possono dipendere da percezioni  di tempo dopo il tempo t. Definiamo una trasduzione 
                ...
                <p className='post-text'>
                    ...
                    Le informazioni che ha a disposizione quando deve farlo sono il suo stato di credenze e le sue attuali percezioni. In questi casi si definisce una <strong> funzione di transizione dello stato di credenza</strong>: <InlineMath math={funzioneCredenza} />, dove S è l'insieme degli stati di credenza e P è gli stati dei possibili percetti. Quindi 
                    la funzione <InlineMath math={funzioneCredenza2} /> indica che <InlineMath math={membro1} /> è lo stato di credenza che segue <InlineMath math={membro2} /> quando <InlineMath math={membro3} /> è osservato. 
                </p>

                <p className='post-text'>
                    E' utile definire anche la <strong>funzione commando</strong> come: <InlineMath math={funzioneComand} />, dove S rappresenta l'insieme degli stati di credenza e P è l'insieme dei possibili percetti, mentre l'insieme C rappresenta l'insieme dei possibili comandi. Quindi la funzione <InlineMath math={funzioneComand2} /> indica che il controller invia il comando 
                    <InlineMath math={membro4} /> quando lo stato di credenza è <InlineMath math={membro2} /> e quando <InlineMath math={membro3} /> è osservato. La funzione di transizione stato-credenza e la funzione di comando insieme specificano una trasduzione causale per l'agente. Se esiste un numero finito di possibili stati di credenza, il 
